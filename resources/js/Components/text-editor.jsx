...
export const RichTextEditor = ({
  ...
  const editor = useEditor({
    editorProps: {
      attributes: {
        class:
          "min-h-[150px] max-h-[150px] w-full rounded-md rounded-br-none rounded-bl-none border border-input px-3 py-2 border-b-0 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 overflow-auto bg-background focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-opacity-50",
      },
    },
    extensions: [
