// resources/js/pages/backoffice/stacks/create.tsx
...
export default function Create() {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Create',
            href: route('backoffice.stacks.create'),
        },
    ];
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(route('backoffice.stacks.store'));
    }
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Fill in the form below to create a new stack.
                    </CardDescription>
                    <CardAction>
...
export function Items({ data, setData }: ItemsProps) {
    ...
    const [currentItem, setCurrentItem] = React.useState<StackItem | null>(null);
    const [name, setName] = React.useState('');

    function handleSort(updatedItems: StackItem[]) {
        setData('items', updatedItems);
    }

    function renderCells(item: StackItem) {
        return (
            <>
    ...
    function handleRowClick(item: StackItem) {
        setCurrentItem(item);
        setName(item.name);
        setOpen(true);
    }

    function handleEdit(e: React.MouseEvent, item: StackItem) {
        e.stopPropagation();
        setCurrentItem(item);
        setName(item.name);
        setOpen(true);
    ...
    function handleDelete(e: React.MouseEvent, item: StackItem) {
        e.stopPropagation();
